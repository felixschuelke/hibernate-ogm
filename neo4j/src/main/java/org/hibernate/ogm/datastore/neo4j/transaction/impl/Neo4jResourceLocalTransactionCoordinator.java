 ...
 * <p>
 * This is inspired by the {@code JdbcResourceLocalTransactionCoordinatorImpl}.
 *
 * @see org.hibernate.resource.transaction.backend.jdbc.internal.JdbcResourceLocalTransactionCoordinatorImp
		...
		public <T> T delegateWork(WorkExecutorVisitable<T> work, boolean transacted) throws HibernateException {
			...
			try {
				...
				try {
					...
					log.unableToRollbackConnection( re );
				}
